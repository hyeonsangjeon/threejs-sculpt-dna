...
from sculpt_dna_core import make_disabled_sculpt_dna
    ...
    return {
        ...
        "sculptPipeline": {
            ...
            "nextRequiredEvidence": [
                "blockout browser render screenshot from the GitHub Copilot in-app Browser",
        ...
        "sculptDNA": make_disabled_sculpt_dna(),
        "repetitionSystems": [],
        "buildPasses": [
            {
                "id": "blockout",
