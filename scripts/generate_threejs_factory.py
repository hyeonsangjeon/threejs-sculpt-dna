...
def generate(
    ...
    *,
    ...
    if spec.get("schemaVersion") == "2.0":
        from generate_threejs_factory_legacy import generate as generate_legacy

        return generate_legacy(spec, pass_id)
...
def main(argv: list[str]) -> int:
    ...
    if raw_spec.get("schemaVersion") == "2.0":
        from generate_threejs_factory_legacy import main as legacy_main
