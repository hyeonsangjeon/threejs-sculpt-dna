...
def make_spec(
    ...
    if complexity is None and intended_use is None and quality_profile is None:
        from new_sculpt_spec_legacy import make_spec as make_legacy_spec

        return make_legacy_spec(target_name, image, assessment_payload)

    complexity = complexity or "moderate"
    intended_use = intended_use or "browser-prop"
